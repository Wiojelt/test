...
class FullHDFilmizleseneCo : MainAPI() {
    private val logTag = "TS-FullHDFilmizleseneCo"
    private fun trace(message: String) = Log.d(logTag, message)
    override var mainUrl = "https://fullhdfilmizlesene.co"
    override var name = "FullHDFilmizleseneCo Test"
    override var lang = "tr"
    override val hasMainPage = true
    override val hasDownloadSupport = true
    override val supportedTypes = setOf(TvType.Movie, TvType.TvSeries)
    override val mainPage = mainPageOf("https://fullhdfilmizlesene.co/seri-filmler/" to "Film ve Diziler")
