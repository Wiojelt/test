...
class NetFilmizle : MainAPI() {
    private val logTag = "TS-NetFilmizle"
    private fun trace(message: String) = Log.d(logTag, message)
    override var mainUrl = "https://netfilmizle.com"
    override var name = "NetFilmizle Test"
    override var lang = "tr"
    override val hasMainPage = true
    override val hasDownloadSupport = true
    override val supportedTypes = setOf(TvType.Movie, TvType.TvSeries)
    override val mainPage = mainPageOf(
        "https://netfilmizle.com/yerli-ve-yabanci-diziler" to "Film ve Diziler",
        "https://netfilmizle.com/turkce-dublaj-filmler/" to "Türkçe Dublaj",
        "https://netfilmizle.com/turkce-altyazili-filmler/" to "Türkçe Altyazı",
        "https://netfilmizle.com/yerli-ve-yabanci-diziler" to "Yerli ve Yabancı Diziler",
        "https://netfilmizle.com/seri-filmler" to "Boxset Seri Filmler",
        "https://netfilmizle.com/yerli-filmler/" to "Yerli Filmler",
        "https://netfilmizle.com/turkce-altyazili-filmler" to "Türkçe Altyazılı Filmler",
        "https://netfilmizle.com/turkce-dublaj-filmler" to "Türkçe Dublaj Filmler",
        "https://netfilmizle.com/yerli-filmler" to "Yerli Filmler",
        "https://netfilmizle.com/yerli-ve-yabanci-diziler/" to "Yerli ve Yabancı Diziler"
    )
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        val target = "".takeIf { it.isNotBlank() }
            ?.replace("{query}", URLEncoder.encode(query, "UTF-8")) ?: "https://netfilmizle.com/yerli-ve-yabanci-diziler"
