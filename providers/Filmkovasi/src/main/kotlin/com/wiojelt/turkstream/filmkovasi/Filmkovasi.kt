...
class Filmkovasi : MainAPI() {
    private val logTag = "TS-Filmkovasi"
    private fun trace(message: String) = Log.d(logTag, message)
    override var mainUrl = "https://filmkovasi.co"
    override var name = "Filmkovasi Test"
    override var lang = "tr"
    override val hasMainPage = true
    override val hasDownloadSupport = true
    override val supportedTypes = setOf(TvType.Movie, TvType.TvSeries)
    override val mainPage = mainPageOf(
        "https://filmkovasi.co/filmizle/18-filmler/" to "Film ve Diziler",
        "https://filmkovasi.co/filmizle/18-filmler/" to "+18 Filmler",
        "https://filmkovasi.co/filmizle/aile/" to "Aile",
        "https://filmkovasi.co/filmizle/aksiyon/" to "Aksiyon",
        "https://filmkovasi.co/filmizle/animasyon/" to "Animasyon",
        "https://filmkovasi.co/filmizle/belgesel/" to "Belgesel",
        "https://filmkovasi.co/filmizle/bilim-kurgu/" to "Bilim Kurgu",
        "https://filmkovasi.co/filmizle/bilim-kurgu-2/" to "Bilim-Kurgu",
        "https://filmkovasi.co/filmizle/cizgi/" to "Çizgi",
        "https://filmkovasi.co/filmizle/cocuk/" to "Çocuk",
        "https://filmkovasi.co/filmizle/dram/" to "Dram",
        "https://filmkovasi.co/filmizle/erotik-filmler/" to "Erotik Filmler",
        "https://filmkovasi.co/filmizle/fantastik/" to "Fantastik",
        "https://filmkovasi.co/filmizle/genclik/" to "Gençlik",
        "https://filmkovasi.co/filmizle/gerilim/" to "Gerilim",
        "https://filmkovasi.co/filmizle/gizem/" to "Gizem",
        "https://filmkovasi.co/filmizle/hint/" to "Hint",
        "https://filmkovasi.co/filmizle/komedi/" to "Komedi",
        "https://filmkovasi.co/filmizle/kore/" to "Kore",
        "https://filmkovasi.co/filmizle/korku/" to "Korku",
        "https://filmkovasi.co/filmizle/macera/" to "Macera",
        "https://filmkovasi.co/filmizle/muzik/" to "Müzik",
        "https://filmkovasi.co/filmizle/polisiye/" to "Polisiye",
        "https://filmkovasi.co/filmizle/psikolojik/" to "Psikolojik",
        "https://filmkovasi.co/filmizle/romantik/" to "Romantik"
    )
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        val target = "".takeIf { it.isNotBlank() }
            ?.replace("{query}", URLEncoder.encode(query, "UTF-8")) ?: "https://filmkovasi.co/filmizle/18-filmler/"
